...
`;document.addEventListener("selectionchange",()=>{u.forEach(e=>{try{_(e)}catch(e){}})}),window.addEventListener("beforeunload",()=>{document.querySelectorAll("img").forEach(e=>{if(e.dataset&&e.dataset._blobUrl)try{URL.revokeObjectURL(e.dataset._blobUrl)}catch(e){}})}),e.WYSIWYG={init:function(e,t){e=e||p.selector;let r=[];return"string"==typeof e?r=Array.from(document.querySelectorAll(e)):e instanceof NodeList||Array.isArray(e)?r=Array.from(e):e instanceof HTMLTextAreaElement&&(r=[e]),r.map(e=>o(e,t))},sanitizeHtml:v};try{e.KriaLite||(e.KriaLite=e.WYSIWYG)}catch(e){}function w(e,s){let l=document.createElement("div"),d=(l.className="wysiwyg-toolbar",s._buttons={},(e,t,r,o={})=>{var i=document.createElement("button"),n=(i.type="button",i.dataset.cmd=e,i.title=o.title||t||e,i.setAttribute("aria-pressed","false"),s&&s.options&&s.options.icons&&s.options.icons[e]||a[e]);return n?(i.innerHTML=n,i.style.display="inline-flex",i.style.alignItems="center",i.style.justifyContent="center",i.style.width=o.width||"36px",i.style.height=o.height||"36px",i.style.padding="6px"):i.textContent=t||e,i.addEventListener("click",e=>{try{r(e)}catch(e){console.error("toolbar handler error",e)}s&&setTimeout(()=>_(s),10)}),l.appendChild(i),s._buttons[e]=i}),c=(t,e="Color")=>{var r=document.createElement("input");return r.type="color",r.title=e,r.addEventListener("input",e=>t(e.target.value)),l.appendChild(r),r};return e.forEach(e=>{var t,r,o,i;if("|"===e)(t=document.createElement("div")).style.width="8px",l.appendChild(t);else switch(e){case"undo":d("undo","Undo",()=>{s&&"function"==typeof s._undo?s._undo():y("undo")},{title:"Undo (Ctrl/Cmd+Z)"});break;case"redo":d("redo","Redo",()=>{s&&"function"==typeof s._redo?s._redo():y("redo")},{title:"Redo (Shift+Ctrl/Cmd+Z)"});break;case"bold":d("bold","Bold",()=>{y("bold"),s&&s._saveSnapshot&&s._saveSnapshot()},{title:"Bold"});break;case"italic":d("italic","Italic",()=>{y("italic"),s&&s._saveSnapshot&&s._saveSnapshot()},{title:"Italic"});break;case"underline":d("underline","Underline",()=>{y("underline"),s&&s._saveSnapshot&&s._saveSnapshot()},{title:"Underline"});break;case"strike":d("strike","Strike",()=>{y("strikeThrough"),s&&s._saveSnapshot&&s._saveSnapshot()},{title:"Strike"});break;case"removeFormat":d("removeFormat","Remove format",()=>{y("removeFormat"),s&&s._saveSnapshot&&s._saveSnapshot()},{title:"Remove formatting"});break;case"h1":d("h1","H1",()=>{y("formatBlock","H1"),s&&s._saveSnapshot&&s._saveSnapshot()},{title:"Heading 1"});break;case"h2":d("h2","H2",()=>{y("formatBlock","H2"),s&&s._saveSnapshot&&s._saveSnapshot()},{title:"Heading 2"});break;case"h3":d("h3","H3",()=>{y("formatBlock","H3"),s&&s._saveSnapshot&&s._saveSnapshot()},{title:"Heading 3"});break;case"p":d("p","P",()=>{y("formatBlock","P"),s&&s._saveSnapshot&&s._saveSnapshot()},{title:"Paragraph"});break;case"fontSize":{var n=[{value:"",label:"Font size"},{value:"1",label:"Small"},{value:"3",label:"Normal"},{value:"5",label:"Large"},{value:"7",label:"Huge"}];var a=e=>{y("fontSize",e||3),s&&s._saveSnapshot&&s._saveSnapshot()};let r=document.createElement("select");n.forEach(e=>{var t=document.createElement("option");t.value=e.value,t.textContent=e.label,r.appendChild(t)}),r.addEventListener("change",e=>a(e.target.value)),l.appendChild(r),r}break;case"fontColor":c(e=>{y("foreColor",e),s&&s._saveSnapshot&&s._saveSnapshot()},"Font color");break;case"bgColor":c(e=>{y("hiliteColor",e),s&&s._saveSnapshot&&s._saveSnapshot()},"Background color");break;case"alignLeft":d("alignLeft","Align left",()=>{y("justifyLeft"),s&&s._saveSnapshot&&s._saveSnapshot()},{title:"Align left"});break;case"alignCenter":d("alignCenter","Align center",()=>{y("justifyCenter"),s&&s._saveSnapshot&&s._saveSnapshot()},{title:"Align center"});break;case"alignRight":d("alignRight","Align right",()=>{y("justifyRight"),s&&s._saveSnapshot&&s._saveSnapshot()},{title:"Align right"});break;case"ul":d("ul","Bulleted list",()=>{y("insertUnorderedList"),s&&s._saveSnapshot&&s._saveSnapshot()},{title:"Bulleted list"});break;case"ol":d("ol","Numbered list",()=>{y("insertOrderedList"),s&&s._saveSnapshot&&s._saveSnapshot()},{title:"Numbered list"});break;case"indent":d("indent","Indent",()=>{y("indent"),s&&s._saveSnapshot&&s._saveSnapshot()},{title:"Indent"});break;case"outdent":d("outdent","Outdent",()=>{y("outdent"),s&&s._saveSnapshot&&s._saveSnapshot()},{title:"Outdent"});break;case"link":d("link","Link",()=>f(s),{title:"Insert link (Ctrl/Cmd+K)"});break;case"image":d("image","Image",()=>{{var l=s;let{dlg:i,close:n}=h(`
      <div>
      ...
      </div>`),a=i.querySelector("#wimg-file");i.querySelector("#wimg-cancel").addEventListener("click",n),i.querySelector("#wimg-insert").addEventListener("click",async()=>{var e,t,r=i.querySelector("#wimg-url").value.trim(),o=a.files&&a.files[0];o?(e=URL.createObjectURL(o),(t=document.createElement("img")).src=e,t.style.maxWidth="100%",x(t,l.editorEl),l._saveSnapshot(),n(),m(o,t,l).catch(e=>{console.warn(e)})):r?(y("insertHTML",`<img src="${C(r)}" style="max-width:100%">`),l._saveSnapshot(),n()):alert("Enter a URL or choose a file")})}},{title:"Insert image"});break;case"table":d("table","Table",()=>{{var[e,r=2,o=2]=[s];let t='<table border="1" style="border-collapse:collapse;width:100%">';for(let e=0;e<r;e++){t+="<tr>";for(let e=0;e<o;e++)t+='<td style="padding:6px"> </td>';t+="</tr>"}y("insertHTML",t+="</table><p></p>"),e._saveSnapshot()}},{title:"Insert table"});break;case"hr":d("hr","HR",()=>{y("insertHorizontalRule"),s&&s._saveSnapshot&&s._saveSnapshot()},{title:"Horizontal rule"});break;case"code":d("code","Code",()=>{var e=s,t=k();y("insertHTML",t?`<pre><code>${b(t)}</code></pre>`:"<pre><code>// code here</code></pre>"),e._saveSnapshot()},{title:"Code block"});break;case"quote":d("quote","Quote",()=>{y("formatBlock","BLOCKQUOTE"),s&&s._saveSnapshot&&s._saveSnapshot()},{title:"Blockquote"});break;case"toggleSource":d("toggleSource","Source",()=>{var e,t=s,{editorEl:r,sourceEl:o}=t;r&&o&&(o.classList.contains("wysiwyg-hidden")?(o.value=r.innerHTML,r.classList.add("wysiwyg-hidden"),o.classList.remove("wysiwyg-hidden"),o.focus()):(e=o.value,r.innerHTML=t.options.sanitize?v(e):e,o.classList.add("wysiwyg-hidden"),r.classList.remove("wysiwyg-hidden"),t._saveSnapshot()))},{title:"Toggle source"});break;case"fullscreen":d("fullscreen","Fullscreen",()=>{var e;(e=s)&&(e.fullscreen?(e.wrapper.classList.remove("wysiwyg-fullscreen"),e.fullscreen=!1):(e._origParent=e.wrapper.parentNode,e._origNext=e.wrapper.nextSibling,e.wrapper.classList.add("wysiwyg-fullscreen"),e.fullscreen=!0))},{title:"Fullscreen"});break;default:n=()=>y(e),o={title:r=e},(i=document.createElement("button")).type="button",i.innerHTML=r,o.title&&(i.title=o.title),i.addEventListener("click",n),l.appendChild(i)}}),l}function v(e){for(var t=document.createElement("div"),r=(t.innerHTML=e,t.querySelectorAll("script,style,iframe,object,embed,link,meta").forEach(e=>e.remove()),document.createTreeWalker(t,NodeFilter.SHOW_ELEMENT,null)),o=[];r.nextNode();)o.push(r.currentNode);return o.forEach(o=>{Array.from(o.attributes||[]).forEach(e=>{var t=e.name.toLowerCase(),r=(e.value||"").toLowerCase();(t.startsWith("on")||"href"===t&&r.startsWith("javascript:"))&&o.removeAttribute(e.name)})}),t.innerHTML}function y(t,e=null){try{document.execCommand(t,!1,e)}catch(e){console.warn("execCommand failed",t,e)}}function h(e,t){let r=document.createElement("div");return r.className="wysiwyg-dialog",r.innerHTML=e,document.body.appendChild(r),{dlg:r,close:function(){try{r.remove()}catch(e){}"function"==typeof t&&t()}}}function f(r){var t=window.getSelection();let o=[];if(t&&t.rangeCount)for(let e=0;e<t.rangeCount;e++)o.push(t.getRangeAt(e).cloneRange());let{dlg:i,close:n}=h(`
    <div>
      <div class="row"><label>URL</label><input type="text" id="wlink-url" placeholder="https://example.com"></div>
      <div class="row"><label>Text</label><input type="text" id="wlink-text" value="${C(k()||"")}"></div>
    ...
    </div>`);i.querySelector("#wlink-cancel").addEventListener("click",n),i.querySelector("#wlink-insert").addEventListener("click",()=>{var e=i.querySelector("#wlink-url").value.trim(),t=i.querySelector("#wlink-text").value.trim();if(e){try{let t=window.getSelection();t.removeAllRanges(),o.length&&o.forEach(e=>t.addRange(e))}catch(e){}t?y("insertHTML",`<a href="${C(e)}" target="_blank" rel="noopener">${b(t)}</a>`):y("createLink",e),r&&r._saveSnapshot&&r._saveSnapshot(),n()}else alert("URL required")})}async function m(e,t,r){if("function"==typeof r.options.uploadHandler)try{var o=await r.options.uploadHandler(e,{onProgress:e=>l(r,e)}),i="string"==typeof o?o:r.options.parseUploadResponse?r.options.parseUploadResponse(o):o&&o.url;i&&(t.src=i,r._saveSnapshot())}catch(e){console.error("uploadHandler error",e)}else if(r.options.uploadUrl)try{var n=await((i,e={},n)=>{let a=e.uploadUrl,l=e.uploadFieldName||"image",s=e.uploadHeaders||{};return a?new Promise((e,t)=>{let r=new XMLHttpRequest;var o=new FormData;o.append(l,i,i.name),r.open("POST",a,!0),Object.keys(s).forEach(e=>{try{r.setRequestHeader(e,s[e])}catch(e){}}),r.upload.onprogress=e=>{e.lengthComputable&&"function"==typeof n&&n(Math.round(e.loaded/e.total*100),e.loaded,e.total)},r.onreadystatechange=()=>{if(4===r.readyState)if(200<=r.status&&r.status<300)try{e(JSON.parse(r.responseText))}catch(e){t(new Error("Invalid JSON from upload endpoint"))}else t(new Error("Upload failed: "+r.status))},r.onerror=()=>t(new Error("Network error")),r.send(o)}):Promise.reject(new Error("uploadUrl not specified"))})(e,r.options,e=>l(r,e)),a=r.options.parseUploadResponse?r.options.parseUploadResponse(n):n&&n.url;a&&(t.src=a)}catch(e){console.error("uploadFileXHR error",e)}}function l(e,t){e&&(e=e.wrapper.querySelector(".wysiwyg-progress"))&&(e.firstElementChild.style.width=Math.max(0,Math.min(100,t||0))+"%")}function x(e,t){var r,o=window.getSelection();o&&o.rangeCount?((r=o.getRangeAt(0)).deleteContents(),r.insertNode(e),r.setStartAfter(e),r.setEndAfter(e),o.removeAllRanges(),o.addRange(r)):t.appendChild(e)}function k(){var t=window.getSelection();if(!t||0===t.rangeCount)return"";var r=document.createElement("div");for(let e=0;e<t.rangeCount;e++)r.appendChild(t.getRangeAt(e).cloneContents());return r.innerHTML}function b(e){return String(e).replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e])}function C(e){return b(e).replace(/"/g,"&quot;")}function S(e){var t,r;e&&({editorEl:e,textarea:t,options:r}=e||{},t)&&(t.value=r&&r.sanitize?v(e&&e.innerHTML||""):e&&e.innerHTML||"")}function _(i){if(i&&i._buttons){let r=i._buttons,o={bold:document.queryCommandState("bold"),italic:document.queryCommandState("italic"),underline:document.queryCommandState("underline"),strike:document.queryCommandState("strikeThrough")};Object.keys(o).forEach(e=>{var t=r[e];t&&(t.classList.toggle("active",!!o[e]),t.setAttribute("aria-pressed",o[e]?"true":"false"))});var e=document.queryCommandState("insertUnorderedList"),t=document.queryCommandState("insertOrderedList");r.ul&&(r.ul.classList.toggle("active",!!e),r.ul.setAttribute("aria-pressed",e?"true":"false")),r.ol&&(r.ol.classList.toggle("active",!!t),r.ol.setAttribute("aria-pressed",t?"true":"false")),["alignLeft","alignCenter","alignRight"].forEach(e=>{let t=!1;"alignLeft"===e&&(t=document.queryCommandState("justifyLeft")),"alignCenter"===e&&(t=document.queryCommandState("justifyCenter")),"alignRight"===e&&(t=document.queryCommandState("justifyRight")),r[e]&&(r[e].classList.toggle("active",!!t),r[e].setAttribute("aria-pressed",t?"true":"false"))});try{var n=window.getSelection();let e=n&&n.anchorNode,t=(e&&3===e.nodeType&&(e=e.parentNode),null);for(;e&&e!==i.editorEl&&(1!==e.nodeType||!(t=e.tagName));)e=e.parentNode;t=t?t.toUpperCase():null,r.h1&&r.h1.classList.toggle("active","H1"===t),r.h2&&r.h2.classList.toggle("active","H2"===t),r.h3&&r.h3.classList.toggle("active","H3"===t),r.p&&r.p.classList.toggle("active",!t||"P"===t||"DIV"===t),r.quote&&r.quote.classList.toggle("active","BLOCKQUOTE"===t),r.code&&r.code.classList.toggle("active","PRE"===t)}catch(e){}try{var a=window.getSelection();let e=a&&a.anchorNode,t=!1;for(;e&&e!==i.editorEl;){if(1===e.nodeType&&"A"===e.tagName){t=!0;break}e=e.parentNode}r.link&&(r.link.classList.toggle("active",!!t),r.link.setAttribute("aria-pressed",t?"true":"false"))}catch(e){}try{var l=window.getSelection();let e=!1;if(l&&l.rangeCount){var s=document.createElement("div");for(let e=0;e<l.rangeCount;e++)s.appendChild(l.getRangeAt(e).cloneContents());s.querySelector&&s.querySelector("img")&&(e=!0)}r.image&&r.image.classList.toggle("active",!!e)}catch(e){}}}function o(e,t){document.getElementById("wysiwyg-widget-styles")||((r=document.createElement("style")).id="wysiwyg-widget-styles",r.textContent=g,document.head.appendChild(r));var r=Object.assign({},p,t||{}),t=document.createElement("div"),o=(t.className="wysiwyg-wrapper",document.createElement("div")),i=(o.className="wysiwyg-editor",o.contentEditable=!0,o.style.minHeight=(r.height||300)+"px",o.innerHTML=e.value||"",document.createElement("textarea"));i.className="wysiwyg-source wysiwyg-hidden",i.style.minHeight=(r.height||300)+"px";let n={textarea:e,wrapper:t,editorEl:o,sourceEl:i,options:r,fullscreen:!1};u.push(n);var a,l,s,d,c=w(r.toolbar,n),h=(t.appendChild(c),t.appendChild(o),t.appendChild(i),e.style.display="none",e.parentNode.insertBefore(t,e.nextSibling),(a=n)._history=[],a._historyIndex=-1,a._saveSnapshot=function(){try{var e=a.editorEl.innerHTML;0<=a._historyIndex&&a._history[a._historyIndex]===e||(a._history.splice(a._historyIndex+1),a._history.push(e),a._historyIndex=a._history.length-1,100<a._history.length&&a._history.shift())}catch(e){console.warn("history save failed",e)}},a._undo=function(){0<a._historyIndex&&(a._historyIndex--,a.editorEl.innerHTML=a._history[a._historyIndex],S(a))},a._redo=function(){a._historyIndex<a._history.length-1&&(a._historyIndex++,a.editorEl.innerHTML=a._history[a._historyIndex],S(a))},a._saveSnapshot(),l=n,window.addEventListener("keydown",l._shortcuts=function(e){var t=e.ctrlKey||e.metaKey;t&&!e.shiftKey&&"z"===e.key.toLowerCase()&&(e.preventDefault(),"function"==typeof l._undo?l._undo():y("undo")),t&&e.shiftKey&&"z"===e.key.toLowerCase()&&(e.preventDefault(),"function"==typeof l._redo?l._redo():y("redo")),t&&"b"===e.key.toLowerCase()&&(e.preventDefault(),y("bold"),l._saveSnapshot()),t&&"i"===e.key.toLowerCase()&&(e.preventDefault(),y("italic"),l._saveSnapshot()),t&&"u"===e.key.toLowerCase()&&(e.preventDefault(),y("underline"),l._saveSnapshot()),t&&"k"===e.key.toLowerCase()&&(e.preventDefault(),f(l)),t&&"s"===e.key.toLowerCase()&&(e.preventDefault(),S(l),"function"==typeof l.options.onSave)&&l.options.onSave(l.getHTML())}),(s=n).editorEl.addEventListener("paste",async function(e){e.preventDefault();var t=e.clipboardData||window.clipboardData;if(t)if(t.files&&t.files.length)for(let e=0;e<t.files.length;e++){var r,o,i=t.files[e];i.type&&i.type.startsWith("image/")&&(r=URL.createObjectURL(i),(o=document.createElement("img")).src=r,o.style.maxWidth="100%",o.dataset._blobUrl=r,x(o,s.editorEl),s._saveSnapshot(),S(s),m(i,o,s).catch(e=>{console.warn("paste image upload failed",e)}))}else{var n=t.getData&&t.getData("text/html");if(n&&n.trim()){y("insertHTML",s.options&&s.options.sanitize?v(n):n),s._saveSnapshot(),S(s);try{_(s)}catch(e){}}else{n=t.getData&&(t.getData("text/plain")||"");if(n){y("insertHTML",n.split(/\r?\n/).map(e=>`<p>${b(e)}</p>`).join("")),s._saveSnapshot(),S(s);try{_(s)}catch(e){}}}}}),n);if(h.options.autosaveKey){let e=h.options.autosaveKey;c=localStorage.getItem(e);c&&(h.editorEl.innerHTML=c),h._autosaveTimer=setInterval(()=>{localStorage.setItem(e,h.editorEl.innerHTML)},3e3)}(d=n).getHTML=()=>d.editorEl.innerHTML,d.setHTML=e=>{d.editorEl.innerHTML=e,S(d),d._saveSnapshot()},d.getText=()=>d.editorEl.innerText,d.insertHtml=e=>{y("insertHTML",e),d._saveSnapshot()},d.destroy=()=>{try{d._autosaveTimer&&clearInterval(d._autosaveTimer),d._shortcuts&&window.removeEventListener("keydown",d._shortcuts),d.wrapper.remove(),d.textarea.style.display="",delete d.textarea._wysiwyg}catch(e){console.warn("destroy failed",e)}},o.addEventListener("input",()=>{S(n),n._saveSnapshot()}),i.addEventListener("input",()=>{}),e.addEventListener("change",()=>{n.editorEl.innerHTML=e.value||""});t=e.closest("form");return t&&t.addEventListener("submit",()=>S(n)),Array.isArray(r.plugins)&&r.plugins.forEach(e=>{try{e(n)}catch(e){console.warn("plugin failed",e)}}),e._wysiwyg=n}}})(window);